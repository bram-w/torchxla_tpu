# ist of changes
# Make trainsize steps * 1000
# Now lowered trainsize will hit epoch swtich logic (hoefully this isn't problem!)
# Just saving every "epoch" which is 1k steps
# added shuffle arg to train dataset
...
def train_imagenet():
    ...
    # Doing below to try to avoid ooms
    for epoch in range(start_epoch, min(FLAGS.num_epochs + 1, start_epoch+10)):
